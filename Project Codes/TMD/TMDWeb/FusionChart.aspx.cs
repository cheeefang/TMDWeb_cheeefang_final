...
{
    public partial class FusionChart : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            FusionCharts.Charts.Chart chart = new FusionCharts.Charts.Chart("column2d", "first_chart", "800", "550", "json", jsonData.ToString());
