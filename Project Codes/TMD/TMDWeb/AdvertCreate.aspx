<%@ Page Title="" validateRequest="false" Language="C#" MasterPageFile="~/Template.Master"  EnableEventValidation="true" AutoEventWireup="true" CodeFile="AdvertCreate.aspx.cs" Inherits="targeted_marketing_display.AdvertCreate"  %>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <p class="input-group" style="float:left; width:300px">
                                            ...
                                            <span class="input-group-btn">
                                                <asp:LinkButton runat="server" class="btn btn-default" ID="btnRun" Style="height: 34px;" Text="<i class='fa fa-search'></i>" autopostback="true" />
                                            </span>
