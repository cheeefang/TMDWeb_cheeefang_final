<%@ Page Language="C#" MasterPageFile="~/Template.Master" AutoEventWireup="true" CodeBehind="newAdvCreate.aspx.cs" Inherits="targeted_marketing_display.newAdvCreate" %>
             ...
             <div class="row">
                <div class="col-lg-6">
                   <div class="form-group">
                        ...
                        &nbsp;
                        <asp:FileUpload ID="FileUploadTB" runat="server" />
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ValidationExpression='(.*?)\.(jpg|jpeg|png|gif|avi|flv|wmv|mp4|mov|JPG|JPEG|PNG|GIF|AVI|FLV|WMV|MOV|MP4)$'
                            ControlToValidate="FileUploadTB" runat="server" ForeColor="Red" ErrorMessage="Please select valid image/video file."
                            Display="Dynamic" />
