<%@ Page Title="" Language="C#" MasterPageFile="~/Template.Master" AutoEventWireup="true" CodeFile="CompanyListing.aspx.cs" Inherits="targeted_marketing_display.CompanyListing" %>
                ...
                <!-- /.row -->
                 ...
                 <div class="row">
                  ...
                  <div style="padding: 20px; float: left; width:30%;">
                    ...
                    <div class="col-lg-6" >      
                        <br />
                        <a href="CompanyCreate.aspx" class="btn btn-primary nextBtn pull-right" type="button"> <b>New Company </b></a>                  
                    </div>               
            </div>
